...
impl LevelBuilder {
    pub fn generate_level_based_on_date(&mut self, entity_system: &mut EntitySystem, particle_vec: &mut ParticleVec, sim: &mut Simulation) {
        ...
        self.generate(&mut level_builder_context, 10); //10);
    }
